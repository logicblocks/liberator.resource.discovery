  ...
  namespace :secrets do
    namespace :gpg do
      RakeGPG.define_generate_key_task(
        ...
        owner_comment: 'liberator.resource.discovery CI Key'
      )
    end
...
RakeCircleCI.define_project_tasks(
  namespace: :circle_ci,
  project_slug: 'github/logicblocks/liberator.resource.discovery'
) do |t|
  circle_ci_config =
...
RakeGithub.define_repository_tasks(
  namespace: :github,
  repository: 'logicblocks/liberator.resource.discovery'
) do |t|
  github_config =
